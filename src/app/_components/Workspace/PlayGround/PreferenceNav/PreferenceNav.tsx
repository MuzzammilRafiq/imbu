...
export default function PreferenceNav ({ setSettings, settings }: PreferenceNavProps){
...
const SettingsListItem = ({fontSize,selectedOption,handleFontSizeChange,}: SettingsListItemProps) => {
  return (
